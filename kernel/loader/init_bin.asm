...
global zirvutil_ifconfig_bin_start
...
align 4096
zirvutil_ifconfig_bin_start:
    incbin "zirvutils/ifconfig.elf"
align 4096
zirvutil_ifconfig_bin_end:

align 4096
zirvutil_lspci_bin_start:
    incbin "zirvutils/lspci.elf"
align 4096
